...
//! They key used to associate an instance of KLTabBarTransitionDelegate with
...
//
//  An instance of the KLTabBarTransitionDelegate class is defined in the
...
- (void)beginInteractiveTransitionIfPossible:(UIPanGestureRecognizer *)sender
{
    ...
    // between this object and the KLTabBarTransitionInteractionController
    // it vends.  If the KLTabBarTransitionInteractionController detects
...
- (id<UIViewControllerAnimatedTransitioning>)tabBarController:(UITabBarController *)tabBarController animationControllerForTransitionFromViewController:(UIViewController *)fromVC toViewController:(UIViewController *)toVC
{
    ...
    if ([viewControllers indexOfObject:toVC] > [viewControllers indexOfObject:fromVC]) {
        ...
        return [[KLTabBarTransitionAnimator alloc] initWithTargetEdge:UIRectEdgeLeft];
    } else {
        // The incoming view controller precedes the outgoing view controller,
        // slide towards the right.
        return [[KLTabBarTransitionAnimator alloc] initWithTargetEdge:UIRectEdgeRight];
    }
}
